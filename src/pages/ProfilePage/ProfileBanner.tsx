    ...
    return (
        <div className="relative w-full min-h-[34rem]">
            ...
            <div className="absolute bottom-2 left-0 mx-6 flex">
                <div>
                    <div className="bg-white h-32 w-32 lg:h-52 lg:w-52 rounded-full overflow-hidden">
                        <ProfileAvatar/>
                    </div>
                </div>
                <div className="flex flex-col gap-1 ml-4 mt-4">
                    ...
                    <ProfileStatsSection/>
                    <div className="flex">
                        <div className="flex items-end text-white gap-1 bg-black bg-opacity-50 px-2">
                            <svg
