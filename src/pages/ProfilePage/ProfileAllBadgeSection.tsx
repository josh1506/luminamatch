...
const ProfileAllBadgeSection: React.FC = () => {
    const displayBadge = [
        {"title": "Newbie", "color": "#E0FFFF"},
        {"title": "Social Butterfly", "color": "#FFDAB9"},
        {"title": "Ice Breaker", "color": "#D3D3F4"},
        {"title": "Chat Champion", "color": "#FFFACD"},
        {"title": "World Explorer", "color": "#F0E68C"},
        {"title": "Trendsetter", "color": "#FFB6C1"},
        {"title": "Quick Responder", "color": "#D3D3D3"},
        {"title": "Most Liked", "color": "#FAFAD2"},
        {"title": "Community Builder", "color": "#F5F5DC"},
        {"title": "Mindful Matcher", "color": "#FFE4B5"},
        {"title": "Rising Star", "color": "#FFF0F5"},
        {"title": "VIP Member", "color": "#E0FFE0"},
    ];

    return (
        <div>
            <h2 className="font-bold text-xl">All Badge</h2>
...
export default ProfileAllBadgeSection;
